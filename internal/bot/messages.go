...
Если остались вопросы просто напиши волшебную фразу "Неработает впн" без каких либо подробностей. 
У нас мощная команда астрологов и тарологов и мы сами быстро поймем в чем дело и найдем решение.`
